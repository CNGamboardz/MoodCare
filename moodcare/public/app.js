...
async function cargarRegistrosEmocionales() {
  ...
  try {
    ...
    const res = await fetch(
      "http://localhost:3000/registros-emocionales"
    );
    ...
    document.getElementById("totalRegistros")
      .innerText = data.totalRegistros;

    document.getElementById("registrosHoy")
      .innerText = data.registrosHoy;

    document.getElementById("promedioGeneral")
      .innerText = data.promedioGeneral;

    document.getElementById("usuariosBajos")
      .innerText = data.usuariosBajos;
        ...
        <tr>
          ...
          <td>
            ...
            <div class="registro-user">
              ...
              <img src="uploads/${item.foto_perfil || 'user.jpg'}">
          ...
          <td>
            ...
            <div class="score-registro ${clase}">
              ${item.puntuacion}
            </div>
    ...
    document.getElementById("contadorRegistros")
      .innerText = `Mostrando ${data.registros.length} registros`;
...
const buscadorRegistro = document.getElementById("buscarRegistro");

if (buscadorRegistro) {

  buscadorRegistro.addEventListener("keyup", () => {

    const texto =
      buscadorRegistro.value.toLowerCase();

    const filas =
      document.querySelectorAll(
        "#tablaRegistrosAdmin tr"
      );
